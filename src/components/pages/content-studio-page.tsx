        ...
        <TabsContent value="voiceover">
          <Card className="border-border/60">
            <CardContent className="flex h-64 flex-col items-center justify-center text-center">
              <div className="flex size-16 items-center justify-center rounded-2xl bg-hermes/10 text-hermes">
                <Icons.Mic className="size-8" />
              </div>
              <h3 className="mt-4 text-lg font-semibold">AI Voiceover Studio</h3>
              <p className="mt-1 max-w-md text-sm text-muted-foreground">
                Convert your scripts into natural-sounding Malaysian voiceovers. Multiple voices, accents, and speeds available.
              </p>
              <Button className="mt-4 bg-hermes-gradient hover:opacity-90" onClick={() => { toast.info('Voiceover studio coming soon!') }}>
